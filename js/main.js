...
// объект одного комментария он скорее всего должне быть одной функцией и все что выше просто в нее добавляем вопрос какие аргументы?
const generateComments = function (countIdComment) {
  ...
  return Array.from({ length: countComment }, createComment);
};
